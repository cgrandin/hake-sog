...
# Convert species name to French if compiling in French
sp <- ifelse(fr(), "merlu du Pacifique", sp)
...
forecast_yrs <- seq(assess_yr + 1, (assess_yr + fore_num_yrs))
...
if(!exists("dat")){
  dat <- readRDS("/srv/hake-sog/hake-2025-07-24.rds")
}
