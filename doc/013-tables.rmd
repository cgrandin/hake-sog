...
cap <- paste0("Annual catches of ", sp, " (t) in the Strait of Georgia, ",
              start_yr, "--", last_data_yr, ". The ", assess_yr, " value is ",
              "not actual data but a projection based on the same catch as ",
              "in ", assess_yr - 1, ".")
if(fr())
  cap <- paste0("Captures annuelles de ", sp, " (t) dans le détroit de Georgia, ",
                start_yr, "--", last_data_yr, ". La valeur pour ", assess_yr,
                " n'est pas une donnée réelle, mais une projection basée sur ",
                "les mêmes prises qu'en ", assess_yr - 1, ".")
...
cap <- "Acoustic survey age-2$+$ biomass estimates and Coefficients of Variation by year."
if(fr())
  cap <- "Estimations de la biomasse et du coefficients de variation par année issues de l'étude acoustique age-2$+$."
