#' Create a table of values of the age 2+ survey biomass estimates
#'
#' @param d A data frame containing the survey history as read in from
#' the file `survey-indices.csv`
#' @param digits Number of decimal places for the index values
